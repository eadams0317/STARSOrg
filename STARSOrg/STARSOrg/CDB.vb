...
Public Class CDB
    Public Function OpenDB() As Boolean
        objSQLCommand = New SqlCommand 'instantiate the command obj
        Dim blnResult As Boolean
        If objSQLConn Is Nothing Then 'we need to instantiate the connection obj
            Try
    ...
    Public Sub CloseDB()
        Try
            objSQLConn.Close() 'close connection to database
    ...
    Public Function GetDataReaderBySP(ByVal strSP As String, ByRef params As ArrayList) As SqlDataReader
        ...
        If Not params Is Nothing Then 'add each parameter into the command obj
    ...
    Public Function GetDataAdapterBySP(ByVal strSP As String, ByRef params As ArrayList) As SqlDataAdapter
        ...
        Try
            ...
            Return sqlDA
        Catch ex As Exception
            MessageBox.Show("Failed to get Data Adapter: " & ex.ToString, "Connection Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
        Return Nothing
    End Function
    Public Function ExecSP(ByRef strSP As String, ByRef params As ArrayList) As Integer
        If Not OpenDB() Then
            Return -1
        End If
        objSQLCommand = New SqlCommand(strSP, objSQLConn)
    ...
    Public Function GetSingleValueFromSP(ByRef strSP As String, ByRef params As ArrayList) As String
        ...
        If Not sqlDR Is Nothing Then 'we got a datareader 
            ...
            End If
        End If
        Return "-2" 'failed to connect or even get a data reade
    End Function
End Class
